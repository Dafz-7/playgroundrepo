...
class CalculatorWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Create display field for the calculator
        ...
        # Create button instances and add them to the layout
        ...
        # Set the layout to the calculator window
        self.setLayout(layout)
...
class TodoListWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Set the layout to the to-do list window
        self.setLayout(layout)
...
class TimerWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Create a QTimeEdit widget to set the time
        ...
        # Set the layout to the timer window
        self.setLayout(layout)
